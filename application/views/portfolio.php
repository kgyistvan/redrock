            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url('img/portfolio/3.png'); ?>" class="img-responsive" alt="3">
                    </a>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url('img/portfolio/2.png'); ?>" class="img-responsive" alt="2">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Upsport</h4>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url('img/portfolio/goodbid400x289.jpg'); ?>" class="img-responsive" alt="1">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Goodbid</h4>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal4" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url('img/portfolio/4.png'); ?>" class="img-responsive" alt="4">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Les+</h4>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal5" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url('img/portfolio/5.png'); ?>" class="img-responsive" alt="5">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Catsj</h4>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url('img/portfolio/6.png'); ?>" class="img-responsive" alt="6">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Skarpnes</h4>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url('img/portfolio/7.png'); ?>" class="img-responsive" alt="7">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Fly Nonstop</h4>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url('img/portfolio/8.png'); ?>" class="img-responsive" alt="8">
                    </a>
                    <div class="portfolio-caption">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url('img/portfolio/9.png'); ?>" class="img-responsive" alt="9">
                    </a>
                    <div class="portfolio-caption">
                        <h4>UN Volunteers</h4>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url('img/portfolio/10.png'); ?>" class="img-responsive" alt="10">
                    </a>
                    <div class="portfolio-caption">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url('img/portfolio/11.png'); ?>" class="img-responsive" alt="11">
                    </a>
                    <div class="portfolio-caption">
                        <h4>HugSar</h4>
                    </div>
